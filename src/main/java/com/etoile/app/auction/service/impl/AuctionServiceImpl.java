...
public class AuctionServiceImpl implements AuctionService {
	...
	@Override // 경매 참여 최근아이디 등록
	public int insertAuctionMemberId(AuctionVO vo) {

		return auctionMapper.insertAuctionMemberId(vo);
	}

	@Override // 즉시낙찰
	public int updateImmediateBid(AuctionVO vo) {

		return auctionMapper.updateImmediateBid(vo);
	}

	@Override // 경매 즉시낙찰 후 배송상태 등록
	public int updateAuctionDelivery(AuctionJoinVO vo) {
		
		return auctionMapper.updateAuctionDelivery(vo);
	}
